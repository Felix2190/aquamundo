...
-- Tiempo de generación: 11-04-2022 a las 05:55:29
...
CREATE TABLE IF NOT EXISTS `encuesta` (
  ...
  `idEmpleadoMejor` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `inegidomgeo_cat_estado`
--

DROP TABLE IF EXISTS `inegidomgeo_cat_estado`;
CREATE TABLE IF NOT EXISTS `inegidomgeo_cat_estado` (
  `CVE_ENT` varchar(2) NOT NULL DEFAULT '',
  `NOM_ENT` varchar(50) NOT NULL,
  PRIMARY KEY (`CVE_ENT`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `inegidomgeo_cat_estado`
--

INSERT INTO `inegidomgeo_cat_estado` (`CVE_ENT`, `NOM_ENT`) VALUES
('00', 'Silueta Express'),
('01', 'AGUASCALIENTES'),
('02', 'BAJA CALIFORNIA'),
...
--
-- Estructura de tabla para la tabla `inegidomgeo_cat_municipio`
--

DROP TABLE IF EXISTS `inegidomgeo_cat_municipio`;
CREATE TABLE IF NOT EXISTS `inegidomgeo_cat_municipio` (
  `CVE_ENT` varchar(2) NOT NULL DEFAULT '',
...
--
-- Volcado de datos para la tabla `inegidomgeo_cat_municipio`
--

INSERT INTO `inegidomgeo_cat_municipio` (`CVE_ENT`, `CVE_MUN`, `NOM_MUN`) VALUES
('00', '000', 'Oficina Central'),
...
ALTER TABLE `visita`
  ...
  ADD CONSTRAINT `visita_ibfk_2` FOREIGN KEY (`idServicio`) REFERENCES `servicio` (`idServicio`);
COMMIT;
